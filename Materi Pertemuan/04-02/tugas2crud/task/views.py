...
def item(req):
    ...
    if req.POST:
        models.item.objects.create(item_name=req.POST['item_name'], item_price=req.POST['item_price'], item_selling_price=req.POST['item_selling_price'])
...
def itemedit(req, id):
    if req.POST:
        models.item.objects.filter(pk=id).update(item_name=req.POST['item_name'], item_price=req.POST['item_price'], item_selling_price=req.POST['item_selling_price'])
