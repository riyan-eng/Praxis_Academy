...
class barangm(models.Model):
    ...
    harga_beli = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
    harga_jual = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
...
class saldoawalm(models.Model):
    ...
    saldo_awal = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)

class SaldoAwal(models.Model):
    owner = models.ForeignKey(User, on_delete = models.DO_NOTHING,related_name='saldoawal')
    saldo_awal = models.IntegerField(default=0, null=True, blank=True)
...
class penjualan1m(models.Model):
    ...
    jatuh_tempo = models.DateField(default=datetime.now, null=True, blank=True)
    saldo_awal = models.DecimalField(default=0, max_digits=10, decimal_places=0)
    kas_masuk = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
    terima = models.IntegerField(default=0, null=True, blank=True)
...
class utangm(models.Model):
    ...
    jumlah = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True)
    jatuh_tempo = models.DateField(default=datetime.now, null=True, blank=True)
    dibayar = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
...
class pend_lainm(models.Model):
    ...
    jatuh_tempo = models.DateField(default=datetime.now, null=True, blank=True)
    pendapatan = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True)
    kas_masuk = models.DecimalField(max_digits=10, decimal_places=0, default=0, null=True, blank=True)
    terima  = models.DecimalField(max_digits=10, decimal_places=0, default=0, null=True, blank=True)
...
class pem_tunaim(models.Model):
    ...
    keterangan = models.CharField(max_length=200)
    jatuh_tempo = models.DateField(default=datetime.now, null=True, blank=True)
    pembelian = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
    kas_keluar = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True)
    dibayar = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
...
class pem_kreditm(models.Model):
    ...
    kuantitas = models.IntegerField(default=0)
    jatuh_tempo = models.DateField(default=datetime.now, null=True, blank=True)
    kas_keluar = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
    dibayar1 = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
...
class pem_lainm(models.Model):
    ...
    jatuh_tempo = models.DateField(default=datetime.now, null=True, blank=True)
    dibayar = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
    utang = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
    catatan = models.CharField(max_length=200)
    dibayar2 = models.DecimalField(default=0, max_digits=10, decimal_places=0, null=True, blank=True)
